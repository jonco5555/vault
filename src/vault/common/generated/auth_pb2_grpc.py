...
import vault.common.generated.auth_pb2 as auth__pb2
...
def add_AuthServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SecureCall': grpc.stream_stream_rpc_method_handler(
                    servicer.SecureCall,
                    request_deserializer=auth__pb2.SecureReqMsgWrapper.FromString,
                    response_serializer=auth__pb2.SecureRespMsgWrapper.SerializeToString,
            ),
    }
